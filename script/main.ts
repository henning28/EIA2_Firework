namespace CustomFirework {
    ...
    export let url: string = "https://webuser.hs-furtwangen.de/~reckhenn/database/index.php";
    ...
    function writeServerList(): void {
        ...
        for (let index: number = 0; index < serverFirework.length; index++) {
            ...
            newPresetDiv.innerHTML += "<img \" class=\"List_Pattern\" src=\"textures/" + String(serverFirework[index].pattern) + ".png\">";
    ...
    function wirteLocalList(): void {
        ...
        for (let index: number = 0; index < localFirework.length; index++) {
            ...
            newPresetDiv.innerHTML += "<img \" class=\"List_Pattern\" src=\"textures/" + String(localFirework[index].pattern) + ".png\">";
