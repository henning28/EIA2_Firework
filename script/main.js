...
(function (CustomFirework) {
    ...
    let background;
    CustomFirework.url = "https://webuser.hs-furtwangen.de/~reckhenn/database/index.php";
    ...
    function writeServerList() {
        ...
        for (let index = 0; index < CustomFirework.serverFirework.length; index++) {
            ...
            newPresetDiv.style.backgroundColor = CustomFirework.serverFirework[index].colour.fColour;
            newPresetDiv.classList.add("List_Preset_Element");
            newInfoDiv.append(newPresetDiv);
            newPresetDiv.innerHTML += "<img \" class=\"List_Pattern\" src=\"textures/" + String(CustomFirework.serverFirework[index].pattern) + ".png\">";
            ...
            newTrashSpan.innerHTML += "<img id=\"serverFireworkDelete" + index + "\" class=\"trash\" src=\"textures/trash.png\">";
    ...
    function getInput() {
        ...
        let currentColor = document.querySelector("#creation_current_colour");
        currentColor.style.backgroundColor = CustomFirework.currentFirework.colour.fColour;
        let currentPattern = document.querySelector("#creation_current_pattern");
        currentPattern.innerHTML = "<img \" class=\"List_Pattern\" src=\"textures/" + String(CustomFirework.currentFirework.pattern) + ".png\">";
    }
    ...
    function wirteLocalList() {
        ...
        for (let index = 0; index < CustomFirework.localFirework.length; index++) {
            ...
            newInfoDiv.append(newNameSpan);
            let newPresetDiv = document.createElement("div");
            newPresetDiv.style.backgroundColor = CustomFirework.localFirework[index].colour.fColour;
            newPresetDiv.classList.add("List_Preset_Element");
            newInfoDiv.append(newPresetDiv);
            newPresetDiv.innerHTML += "<img \" class=\"List_Pattern\" src=\"textures/" + String(CustomFirework.localFirework[index].pattern) + ".png\">";
            let newSizeSpan = document.createElement("span");
            let newDurationSpan = document.createElement("span");
            newSizeSpan.classList.add("List_Size_Span");
            newDurationSpan.classList.add("List_Duration_Span");
            ...
            newPresetDiv.append(newDurationSpan);
            let newTrashSpan = document.createElement("span");
            newTrashSpan.innerHTML += "<img id=\"localFireworkDelete" + index + "\" class=\"trash\" src=\"textures/trash.png\">";
            newTrashSpan.classList.add("List_Trash");
            newInfoDiv.append(newTrashSpan);
            newLi.append(newInfoDiv);
            list.append(newLi);
